...
import logging
from tests.collection_count_test import CollectionCountTest
from tests.facet_load_test import FacetLoadTest
from tests.site_availibility_test import SiteAvailabilityTest
from tests.viewer_tests import OpenSeaDragonLoadTest, MiradorLoadTest, AblePlayerLoadTest, AblePlayerTranscriptLoadTest
